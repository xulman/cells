...
CellAndEnergy = tuple[int, int]  # cell_id, number_of_pixel_pairs_examined
DistancesToCellsWithEnergies = dict[int, CellAndEnergy]  # distance -> id+energy
DistMatrix = dict[int, DistancesToCellsWithEnergies]
